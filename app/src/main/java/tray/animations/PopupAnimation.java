...
public class PopupAnimation implements TrayAnimation {
    ...
    public PopupAnimation(CustomStage s, double delaySpeed) {
    ...
    private Timeline setupDismissAnimation() {
        ...
        KeyFrame kf1 = new KeyFrame(Duration.millis(2000 * speedMulti), kv1);

        KeyValue kv2 = new KeyValue(stage.opacityProperty(), 0.0);
        KeyFrame kf2 = new KeyFrame(Duration.millis(2000 * speedMulti), kv2);
    ...
    private Timeline setupShowAnimation() {
        ...
        KeyFrame kf2 = new KeyFrame(Duration.millis(1000 * speedMulti), kv2);
        ...
        KeyFrame kf4 = new KeyFrame(Duration.millis(2000 * speedMulti), kv4);
