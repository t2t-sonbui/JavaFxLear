...
public class SlideAnimation implements TrayAnimation {
    ...
    public SlideAnimation(CustomStage customStage) {
        this(customStage, 1.0);
    }

    public SlideAnimation(CustomStage customStage, double delaySpeed) {
        speedMulti = delaySpeed;
    ...
    private Timeline setupShowAnimation() {
        ...
        KeyFrame frame2 = new KeyFrame(Duration.millis(1300 * speedMulti), kvInter);
        ...
        KeyFrame frame4 = new KeyFrame(Duration.millis(1000 * speedMulti), kvOpacity2);
    ...
    private Timeline setupDismissAnimation() {
        ...
        KeyFrame frame1 = new KeyFrame(Duration.millis(1400 * speedMulti), kvX);
        ...
        KeyFrame frame2 = new KeyFrame(Duration.millis(2000 * speedMulti), kvOpacity);
